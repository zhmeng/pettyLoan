				...
				<div class="infocontent">
					<table id="table1" style="width:100%;" cellpadding="0" cellspacing="0" class="tableList">
						...
						<tr>
		                    ...
		                    <td style="padding-top: 2px; padding-left: 2px;" class="style2">
		                    	<input type="text" id="compnyName" name="compnyName"/>
		                    </td>
						...
						<tr>
		                    ...
		                    <td style="padding-top: 2px; padding-left: 2px;" class="style2">
		                    	<input type="text" id="linkmn" name="linkmn"/>
		                    </td>
						...
						<tr>
		                    ...
		                    <td class="style2" style="padding-top: 2px; padding-left: 2px;">
		                    	<input type="text" id="fimallyPhone" name="fimallyPhone"/>
		                    </td>
						</tr>
						...
						<tr>
		                    <td style="font-weight: bold; border-right: #ccc 1px solid;" align="right">生日：</td>
		                     <td style="padding-top: 2px; padding-left: 2px;" class="style2">
		                    	<input type="text" id="birthday" name="birthday" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/>
		                    </td>
						...
						<tr>
		                    <td style="font-weight: bold; border-right: #ccc 1px solid;" align="right">上级公司：</td>
		                     <td style="padding-top: 2px; padding-left: 2px;" class="style2">
		                     	<input type="text" id="pid" name="pid" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();"/>(上级公司编码)
		                    	<!-- <input type="text" id="pid" name="pid"/> -->
		                    <%-- 	<select id=pid name="pid">
		                    		<option value="">--</option>
		                    		<c:forEach items="${listFile}" var="bean">
		                    			<option value="${bean.id}">${bean.compnyName}</option>
		                    		</c:forEach>
		                    	</select> --%>
		                    </td>
		                    <td style="font-weight: bold; border-right: #ccc 1px solid;" align="right">公司类型：</td>
		                    <td class="style2" style="padding-top: 2px; padding-left: 2px;">
		                    	<!-- <input type="text" id="compClass" name="compClass"/> -->
		                    	<select id="compClass" name="compClass">
		                    		<c:forEach items="${sysDepList}" var="deptList">
