...
<table id="table1" style="width:100%;" cellpadding="0" cellspacing="0" class="tableList">
	<tr>
		<td style="font-weight: bold; border-right: #ccc 1px solid;" align="right"><span style="color:red">*</span>业务编号：</td>
        <td style="padding-top: 2px; padding-left: 2px;" class="style2">
        	<input type="text" value="${product.productKey}" id="productKey">
        </td>
        <td style="font-weight: bold; border-right: #ccc 1px solid;" align="right"><span style="color:red">*</span>业务名称：</td>
        <td style="padding-top: 2px; padding-left: 2px;" class="style2">
        	<input type="text" value="${product.productName}" id="productName">
        </td>
	</tr>
	<tr>
        <td style="font-weight: bold; border-right: #ccc 1px solid;" align="right">业务状态：</td>
        <td style="padding-top: 2px; padding-left: 2px;" class="style2">
        ...
        <td style="font-weight: bold; border-right: #ccc 1px solid;" align="right"><span style="color:red">*</span>业务描述：</td>
        <td style="padding-top: 2px; padding-left: 2px;" class="style2">
	...
	<tr>
        ...
        <td style="font-weight: bold; border-right: #ccc 1px solid;" align="right"><span style="color:red">*</span>利息(%)：</td>
        <td style="padding-top: 2px; padding-left: 2px;" class="style2">
...
<table id="table1" style="width:100%;" cellpadding="0" cellspacing="0" class="tableList">
	<tr>
		<td style="font-weight: bold; border-right: #ccc 1px solid;" align="right">合同模板：</td>
        <td class="style2" style="padding-top: 2px; padding-left: 2px;">
       		<c:forEach var="imgIdList" items="${imgIdList}">
       			<input type="checkbox" id="imgIds" name="imgIds" value="${imgIdList.cid}" 
       			<c:if test='${imgIdList.isShow==1}'>checked="checked"</c:if>/>${imgIdList.cName}<br>
       		</c:forEach>
        </td>
	</tr>
</table>
